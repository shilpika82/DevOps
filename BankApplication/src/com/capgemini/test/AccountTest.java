...
public class AccountTest {
	...
	@Test
	public void depositsuccessful() throws InvalidAccountNumberException
	{
		Account account= new Account();
		account.setAccountNumber(100);
		account.setAmount(233);
		accountService.depositAmt(account.getAccountNumber(), account.getAmount());
	}

	@Test
	public void invaliddepositthrowexception() throws InvalidAccountNumberException{
		Account account=new Account();
		account.setAccountNumber(200);
		account.setAmount(111);
		accountService.depositException(123, 123);
	}
	...
	public void withdrawsuccessful() {
		...
		account.setAccountNumber(200);
		account.setAmount(111);
		accountService.WithdrawSuccess(123, 123);
	}
	@Test
	public void WithdrawInsufficientBalanceException(){
		accountService.WithdrawInsufficientBalanceException(123, 123);
	}
	
	@Test(expected=com.capgemini.exceptions.InvalidAccountNumberException.class)
	public void WithdrawInvalidAccountException() throws InvalidAccountNumberException{
		accountService.WithdrawInvalidAccountException(124, 11);
	}
}
